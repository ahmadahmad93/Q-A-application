...
<div class="footerHeader" ></div>
    <div class="container">
		...
		<div class="col-md-4" style="float: right">
		    <h3 class="text-right">الاتصال بنا </h3>
		    <ul>
		        <li class="text-right">هاتف: 0999000000</li>
                        <li class="text-right" dir="rtl">بريد الكتروني: help@me.com</li>
		    </ul>
